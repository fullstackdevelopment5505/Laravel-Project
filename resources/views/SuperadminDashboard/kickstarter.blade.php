                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" id="mortgageAmountFrom" name="mortgageAmountFrom" class="form-control" placeholder="amount">
                            </div>
                        </div>
                       ...
                       <div class="col-sm-4">
                            <div class="form-group">
                                <label>To</label>
                                <input type="text" id="mortgageAmountTo" name="mortgageAmountTo" class="form-control" placeholder="amount">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" name="mortgageInterestFrom" id="mortgageInterestFrom" class="form-control" placeholder="percent">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>To</label>
                                <input type="text" name="mortgageInterestTo" id="mortgageInterestTo" class="form-control" placeholder="percent">
                            </div>
                        </div>
						<div class="col-sm-12">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" name="equityFrom" id="equityFrom" class="form-control" placeholder="percent" >
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>To</label>
                                <input type="text" name="equityTo" id="equityTo" class="form-control" placeholder="percent">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" name="listingPriceFrom" id="listingPriceFrom" class="form-control" placeholder="amount">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>To</label>
                                <input type="text" name="listingPriceTo" id="listingPriceTo" class="form-control" placeholder="amount">
                            </div>
                        </div>
                       ...
                       <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>From</label>
                                <input type="text" name="forclosureAmountFrom" id="forclosureAmountFrom" class="form-control" placeholder="amount" >
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>To</label>
                                <input type="text" name="forclosureAmountTo" id="forclosureAmountTo" class="form-control" placeholder="amount">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#createKickstarterModal').on('show.bs.modal', function() {
        ...
        if(typeof kickstart_id !==  "undefined"){
            ...
            var country = span.children("span.country").text();
            var city = span.children("span.city").text();
            var state = span.children("span.state").text();
            var postal_code = span.children("span.postal_code").text();
            var description = span.children("span.description").text();
            var address = span.children("span.address").text();
            ...
            $("input[name='user_image']").val(address);
	...
	$(document).on('click', ".search_form_button", function() {
        $(this).addClass('edit-item-trigger-clicked');
        var options = {
            'backdrop': 'static'
        };
