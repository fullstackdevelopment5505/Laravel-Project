				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Unpaid Earned Commission</div>
								<h3 class="total_sale_earning">$1,234.56</h3>
							</div>
						</div>
						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Next Commission Disbursement </div>
								<h3 class="total_sale_earning">28-02-2020</h3>
							</div>
						</div>
						<!-- all graphs start
						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Commissions Bar Graph</div>
								<canvas id="commission-chart" width="800" height="450"></canvas>
							</div>
						</div>

						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Commission by Top Ten Customers</div>
								<canvas id="top-ten-chart" width="800" height="450"></canvas>
							</div>
						</div>

						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Lowest Five Earnings Customers</div>
								<canvas id="lowest-earning" width="800" height="450"></canvas>
							</div>
						</div>

						<div class="col-sm-6 top_selling">
							<div class="inside">
								<div class="title">Monthly Earning by Customer</div>
								<canvas id="monthly-earning" width="800" height="450"></canvas>
							</div>
						</div>
						<!-- all graphs end-->
					</div>
