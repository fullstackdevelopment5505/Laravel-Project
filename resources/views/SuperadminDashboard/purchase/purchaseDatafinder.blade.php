		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body register_new_user">
				  <form action="{{route('adddataFin.add')}}" method="post" id="customerForm" >
					{{@csrf_field()}}
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
	...
	<div class="modal fade" id="myModal1">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body register_new_user">
				  <form action="{{route('adddataFinBulk.add')}}" method="post" id="customerForm1" >
					{{@csrf_field()}}
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
...
$('#search_submit').click(function(){	
    ...
    var table = $('#purchaseDatafinder').DataTable({
		processing: true,
		responsive: true,
		serverSide: true,
		dom: 'lBfrtip',
