				...
				<div class="col-sm-12 top_bar_area">
					<div class="row">
						...
						<div class="col-sm-4 top_btns">
							<a href="{{route('superadminSendMessage')}}" class="btn btn-primary">Send Message <i class="fa fa-plus"></i></a>
						</div>
					</div>
				</div>
				<!-- datepicker -->
                        ...
                        <div class="col-sm-12 top_selling">
							<div class="inside">
								<div class="communications">
                                    <ul>
                                        <li>
                                            <a href="view-message.php?active=message">
                                        ...
                                        <li>
                                            <a href="{{route('superadminViewMessage')}}">
                                                <label><input type="checkbox"><span></span></label>
                                                <div class="pic"><img src="{{asset('assets/superadmin/images/user.jpg')}}"></div>
                                                <div class="data">
                                                    <h2>Velit A Labore</h2>
