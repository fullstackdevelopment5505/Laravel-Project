        		...
        		<div class="alert alert-success">
					...
					@endif
						...
						<div class="col-sm-12 top_selling">
							<div class="inside">
								<div class="title">Purchase Vouchers</div>
								<table class="display responsive nowrap" width="100%" id="voucherList">
									<thead>
										<tr>
											<th>Date</th>
											<th>Voucher No</th>
	...
	<div class="modal fade" id="myModal">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form action="{{route('Purchasevouchers.add')}}" method="post" id="customerForm" required>
					{{@csrf_field()}}
					<div class="row">
						<!-- <div class="col-sm-6">
							<div class="form-group">
							    <label>Voucher Number</label>
							    <input type="hidden" class="form-control" name="voucher_no" id="voucher_no" required autocomplete="off">
							</div>
						</div> -->
						...
						<div class="col-sm-6">
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" name="rem_total" id="rem_total" readonly >
							</div>
						</div>
					</div>
        ...
        <form id="productForm" name="productForm" class="form-horizontal" method="post" action="{{route('Purchasevouchers.update')}}">
		   ...
		   <div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
							    <label>Total Amount</label>
							    <input type="number" class="form-control" name="amount" required onChange="onChange(this)" id="amount" value="" min="1" > 
							</div>
						</div>
...
<!-- Fetching sale report list -->
    ...
    $('#search_submit_purchase').click(function(){	
        $('#voucherList').DataTable().draw(true);
    });
	$(function() {
