							...
							<div class="row">
								<div class="col-sm-8 from_to_filter">
									...
									<div class="form-group">
										<label>From:</label>
										<input type="text" id="date_from_sale" name="date_from_sale" class="form-control datepickerSuper" placeholder="Date">
									</div>
									<div class="form-group">
										<label>To:</label>
										<input type="text" id="date_to_sale" name="date_to_sale" class="form-control datepickerSuper" placeholder="Date">
									</div>
										<!-- <div class="form-group">
										    <label>Status:</label>
										...
										<button type="button" id="search_submit_sale" class="btn btn-success">Search</button>
									</form>
								</div>
								<div class="col-sm-4 top_btns">
									<button class="btn btn-primary customClass" data-toggle="modal" data-target="#myModal">Create New Invoice<i class="fa fa-plus"></i></button>
								</div>
							</div>
						</div>
						<!-- datepicker -->
						...
						<div class="col-sm-12 top_selling">
							<div class="inside">
								<div class="title">Sale Invoice</div>
									<table class="display responsive nowrap" width="120%" id="invoiceList">
										<thead>
											<tr>
				...
				<div class="row">
						...
						<div class="col-sm-6">
							...
							<table class="table" >
								...
								<tr>
									<td> GSTIN </td>
									<td><input type="text" name="gstin" id="gstin" size="40" required></td>
								</tr>
							</table>
							</div>
						</div>
						<div class="col-sm-6">
							...
							<table class="table" >
								<tr>
									...
									<td>
									<input type="text" name="invoice_prefix" id="invoice_prefix" size="40" required>
									</td>
								</tr>
								<tr>
									<td>Date</td>
						...
						<div class="col-sm-6">
							...
							<table class="tab" >
								<tr>
									...
									<td>
									<input type="TEXT" name="rec_name" id="rec_name" size="40" required>
									</td>
								</tr>
								<tr>
									<td>Address</td>
									<td ><textarea type="text" name="rec_address" id="rec_address" rows="2" style="width:365px; height:50px" required></textarea></td>
								</tr>
								<tr>
									<td><label>State</label></TD>
									<td>
									<input type="TEXT" name="rec_state" id="rec_state" size="40" required>
									</td>
								</tr>
								<tr>
									<td>Sate Code</td>
									<td><input type="text" name="rec_state_code" id="rec_state_code" size="40" required></td>
								</tr>
								<tr>
									<td><label>GSTIN/Unique ID</label></TD>
									<td>
									<input type="text" name="rec_gstin" id="rec_gstin" size="40" required>
									</td>
								</tr>
				     	...
				     	<label>Same as Reciever</label>
    						...
    						<table class="tab" >
								<tr>
									<td><label>Name</label></TD>
									<td>
									<input type="TEXT" name="con_name" id="con_name" size="40" required>
									</td>
								</tr>
								<tr>
									<td>Address</td>
									<td><textarea type="text" name="con_address" id="con_address" size="40" style="width:365px; height:50px" required></textarea></td>
								</tr>
								<tr>
									<td><label>State</label></TD>
									<td>
									<input type="TEXT" name="con_state" id="con_state" size="40" required>
									</td>
								</tr>
								<tr>
									<td>Sate Code</td>
									<td><input type="text" name="con_state_code" id="con_state_code" size="40" required></td>
								</tr>
								<tr>
									<td><label>GSTIN/Unique ID</label></TD>
									<td>
									<input type="TEXT" name="con_gstin" id="con_gstin" size="40" required>
									</td>
								</tr>
					...
					<div class="row">
						...
						<div class="col-sm-12 total">
							<h1>Total: <input type="text" id="finalamount" name="finalamount" size="9" readonly /></h1>
						</div>
					</div>
...
var table = $('#invoiceList').DataTable({
	...
	ajax: {
		url: "{{route('invoices')}}",
		data: function (d) {
				d.date_from_sale = $('input[name="date_from_sale"]').val();
				d.user_id = $('input[name="user_id"]').val();
				d.type = 'purchased_record';
				d.date_to_sale =$('input[name="date_to_sale"]').val();
...
$('#search_submit_sale').click(function(){	
	$('#invoiceList').DataTable().draw(true);
});
$(function() {

$('#date_from_sale').datepicker({
...
if (input.id === "date_from_sale") {
dateMax = 'now';	
}
if (input.id === "date_to_sale") {
dateMin = $('#date_from_sale').datepicker('getDate');
}
