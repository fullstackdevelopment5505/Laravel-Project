@if(count($highly_interested_properties) >0)
 @foreach($highly_interested_properties as $value)   
...
<div class="col-sm-12 mt-4 mb-3">
    <div class="pagination"> {!! $highly_interested_properties->render() !!} </div>
</div>
