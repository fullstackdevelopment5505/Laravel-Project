					...
					<div class="row row-eq-height">
						<div class="col-md-12 main_btn">
							<div class="flex_btn">
								...
								<div class="add_btn">
									<a href="{{route('saleExecutiveAddTeam')}}"><i class=" fa fa-plus"></i>Add New</a>
								</div>
							</div>
						</div>
						<!--property data start -->
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <form id="productForm" name="productForm" class="form-horizontal" method="post" action="{{route('saleExecutive.updateTeam')}}">
           {{@csrf_field()}}
		   <div class="main_form">
		...
		$(document).ready(function() {
			$('#teamList').DataTable({
				...
				"columns":[
					...
					{"data":"phoneno",className:"phoneno"},
