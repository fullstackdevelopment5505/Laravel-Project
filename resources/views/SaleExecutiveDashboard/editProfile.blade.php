                            ...
                            <div class="col-sm-12 top_bar_area">
                                <div class="row">
                                    <div class="col-sm-12 from_to_filter">
                                        <form>
                                            <div class="view_back"><a href="{{route('saleExecutiveCustomerProfile')}}"><i class="fa fa-arrow-left"></i></a></div>
                                    ...
                                    <div class="inside about_customer">
                                        <div class="row">
                                            <div class="col-sm-3 edit_profile_image">
                                                <div class="inset">
                                                    <label>
                                                        <span><img src="{{asset('assets/saleExecutive/images/photo.svg')}}"></span>
                                                        <input type="file">
                                                    </label>
                                                </div>
                                            </div>
