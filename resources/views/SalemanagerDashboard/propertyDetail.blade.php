...
<div class="main_area">
	...
	<a href="{{route('salemanagerProperties')}}"><i class="fa fa-arrow-left"></i></a>
        @include('SuperadminDashboard.layouts.header')
		<section id="mapview">
	<div class="col-md-12">
		<div class="row">
			<div class="col-md-4 nopadding fixdpic"><img src="{{asset('assets/salemanager/images/real-estate.jpg')}}"></div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="share_box">
					<div class="favicons2">
						<ul>
							<li><a href="javascript:void()" title="notes" data-toggle="modal" data-target="#myModal" class="intro"><img src="{{asset('assets/salemanager/images/notes.png')}}"></a></li>
							<li>
								<a href="javascript:void()" title="lightbulb">
									<img src="{{asset('assets/salemanager/images/bulb.png')}}" class="bulb">
									<img src="{{asset('assets/salemanager/images/bulb2.png')}}" class="bulb2">
								</a>
							</li>
							<li>
								<a href="javascript:void()" title="fire">
									<img src="{{asset('assets/salemanager/images/fire.png')}}"  class="fire">
									<img src="{{asset('assets/salemanager/images/fire2.png')}}" class="fire2">
								</a>
							</li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body2" id="notes_bg">
        	<div class="owner_detail">
        		<div class="ownpic"><img src="{{asset('assets/salemanager/images/owner.png')}}"></div>
		...
		<div class="row">
			<div class="col-md-8 col-lg-9">
				...
				<div class="prop_head_link">
					<div class="grid_box">
						<img src="{{asset('assets/salemanager/images/pbed.png')}}">
						<h2>Bedroom</h2>
						<p>{{$propertyDetail->Bedrooms}}</p>
					</div>
					<div class="grid_box">
						<img src="{{asset('assets/salemanager/images/pbath.png')}}">
						<h2>baths ( F/ H )</h2>
						<p>{{$propertyDetail->Bathrooms}}</p>
					</div>
					<div class="grid_box">
						<img src="{{asset('assets/salemanager/images/pliving.png')}}">
						<h2>Living Area</h2>
						<p>2</p>
					</div>
					<div class="grid_box">
						<img src="{{asset('assets/salemanager/images/lotarea.png')}}">
						<h2>Lot Area</h2>
